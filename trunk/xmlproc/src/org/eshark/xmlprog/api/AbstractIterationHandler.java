 ...
 * File Name     :: AbstractIterationHandler.java
 * Created on    :: Mar 28, 2008 10:14:50 AM
 ...
 *---------------------------------------------------------------------
 */
public abstract class AbstractIterationHandler implements IGenericHandler
{
	...
	{
		iterate(aConfigElement);
	}

	/**
	 * @author       :: Subhasish Chattopadhyay
	 * Introduced on :: Mar 28, 2008 12:24:17 PM
	 * Purpose       ::
	 *
	 * @version      :: 
	...
	public abstract void iterate(IConfigElement aConfigElement)throws XMLProgLogicException;
}
