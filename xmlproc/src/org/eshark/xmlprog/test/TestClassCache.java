 ...
 * File Name     :: TestClassCache.java
 * Created on    :: Mar 17, 2008 3:24:10 PM
...
{
	public static void main(String[] args) throws XMLProgFormatException
	{
		ClassCache		cc	= ClassCache.getClassCache();
		cc.loadFromXML(null);
